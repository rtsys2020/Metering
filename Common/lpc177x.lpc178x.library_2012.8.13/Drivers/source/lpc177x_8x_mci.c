...
int32_t MCI_Init(uint8_t powerActiveLevel )
{
    ...
    //LPC_IOCON->P1_2  &= ~0x1F;
		/* SD_CLK @ P1.2 */
		PINSEL_ConfigPin(MMC_CLK_PORT_NUM, MMC_CLK_PIN_NUM, 0);
			   GPIO_SetDir(MMC_CLK_PORT_NUM, (1<<MMC_CLK_PIN_NUM), 1);
		 GPIO_ClearValue(MMC_CLK_PORT_NUM, (1<<MMC_CLK_PIN_NUM));
    //LPC_IOCON->P1_3  &= ~0x1F; 
		/* SD_CMD @ P1.3 */
	  PINSEL_ConfigPin(MMC_CMD_PORT_NUM, MMC_CMD_PIN_NUM, 0);
				 GPIO_SetDir(MMC_CMD_PORT_NUM, (1<<MMC_CMD_PIN_NUM), 1);
		 GPIO_ClearValue(MMC_CMD_PORT_NUM, (1<<MMC_CMD_PIN_NUM));
    //LPC_IOCON->P1_5  &= ~0x1F; 
		/* SD_PWR @ P1.5 */
		PINSEL_ConfigPin(MMC_PWR_PORT_NUM, MMC_PWR_PIN_NUM, 0);
				 GPIO_SetDir(MMC_PWR_PORT_NUM, (1<<MMC_PWR_PIN_NUM), 1);
		   GPIO_SetValue(MMC_PWR_PORT_NUM, (1<<MMC_PWR_PIN_NUM));
    //LPC_IOCON->P1_6  &= ~0x1F; 
		/* SD_DAT_0 @ P1.6 */
		PINSEL_ConfigPin(MMC_DATA0_PORT_NUM, MMC_DATA0_PIN_NUM, 0);
				 GPIO_SetDir(MMC_DATA0_PORT_NUM, (1<<MMC_DATA0_PIN_NUM), 1);
		 GPIO_ClearValue(MMC_DATA0_PORT_NUM, (1<<MMC_DATA0_PIN_NUM));
    //LPC_IOCON->P1_7  &= ~0x1F; 
		/* SD_DAT_1 @ P1.7 */
		PINSEL_ConfigPin(MMC_DATA1_PORT_NUM, MMC_DATA1_PIN_NUM, 0);
				 GPIO_SetDir(MMC_DATA1_PORT_NUM, (1<<MMC_DATA1_PIN_NUM), 1);
		 GPIO_ClearValue(MMC_DATA1_PORT_NUM, (1<<MMC_DATA1_PIN_NUM));
    //LPC_IOCON->P1_11 &= ~0x1F; 
		/* SD_DAT_2 @ P1.11 */
		PINSEL_ConfigPin(MMC_DATA2_PORT_NUM, MMC_DATA2_PIN_NUM, 0);
		GPIO_SetDir(MMC_DATA2_PORT_NUM, (1<<MMC_DATA2_PIN_NUM), 1);
		GPIO_ClearValue(MMC_DATA2_PORT_NUM, (1<<MMC_DATA2_PIN_NUM));
    //LPC_IOCON->P1_12 &= 0x1F; 
		/* SD_DAT_3 @ P1.12 */
		PINSEL_ConfigPin(MMC_DATA3_PORT_NUM, MMC_DATA3_PIN_NUM, 0);
		GPIO_SetDir(MMC_DATA3_PORT_NUM, (1<<MMC_DATA3_PIN_NUM), 1);
		GPIO_ClearValue(MMC_DATA3_PORT_NUM, (1<<MMC_DATA3_PIN_NUM));
...
//		LPC_GPIO1->SET = 0x0020;//power control
    ...
    //SD_CLK
    PINSEL_ConfigPin(MMC_CLK_PORT_NUM, MMC_CLK_PIN_NUM, MMC_CLK_FUNC_NUM);
    //SD_CMD
    PINSEL_ConfigPin(MMC_CMD_PORT_NUM, MMC_CMD_PIN_NUM, MMC_CMD_FUNC_NUM);
    //SD_PWR
    PINSEL_ConfigPin(MMC_PWR_PORT_NUM, MMC_PWR_PIN_NUM, MMC_PWR_FUNC_NUM);
    //SD_DAT_0
    PINSEL_ConfigPin(MMC_DATA0_PORT_NUM, MMC_DATA0_PIN_NUM, MMC_DATA0_FUNC_NUM);
    //SD_DAT_1
    PINSEL_ConfigPin(MMC_DATA1_PORT_NUM, MMC_DATA1_PIN_NUM, MMC_DATA1_FUNC_NUM);
    //SD_DAT_2
    PINSEL_ConfigPin(MMC_DATA2_PORT_NUM, MMC_DATA2_PIN_NUM, MMC_DATA2_FUNC_NUM);
    //SD_DAT_3
    PINSEL_ConfigPin(MMC_DATA3_PORT_NUM, MMC_DATA3_PIN_NUM, MMC_DATA3_FUNC_NUM);
