...
#include "includes.h"
extern const uint32_t PCLK_MASK ;
extern const uint32_t VSYNC_MASK ;
extern const uint32_t HSYNC_MASK ;
extern const uint32_t PCLK_MASK_NOT ;
extern const uint32_t HSYNC_MASK_NOT ;
